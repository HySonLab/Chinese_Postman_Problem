...
rm -rf test_greedy test_ils_multithreads test_vns test_ea_multithreads test_aco_multithreads test_brute_force_multithreads
...
./test_aco_multithreads data/small_$idx.txt
